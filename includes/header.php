...
<body>
    <header>
        <div class="sidebar">
            <div class="secao">
                <h4>Gerenciamentos</h4>
                <a href="../pages/cliente.php">Gerenciar Clientes</a>
                <a href="../pages/funcionario.php">Gerenciar Funcionários</a>
                <a href="../pages/servico.php">Gerenciar Serviços</a>
                <a href="../pages/produto.php">Gerenciar Produtos</a>
                <a href="../pages/">Gerenciar Veículos</a>
                <a href="../pages/forma-pagamento.php">Gerenciar Formas de Pagamentos</a>
                <a href="../pages/ordem.php">Gerenciar Ordens de Serviços</a>
            </div>
            <br>
            <div class="secao">
                <h4>Consulta Ficha</h4>
                <a href="../pages/fichas-automotivas.php">Consultar Fichas de Veículos</a>
            </div>
