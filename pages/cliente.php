...
<div class="container mt-4">
    ...
    <button id="btnAbrirModalCadastro" class="btn-cadastrar">Cadastrar Cliente</button>
...
<div id="modalCadastro" class="modal-forma-pagamento">
    <div class="modal-content-forma">
        ...
        <!-- Formulário de Dados Pessoais e Endereço Unificado -->
        <div class="container-formularios">
            <form action="../config/crud-cliente/create.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="dados-pessoais-container">
                        <!-- Coluna da imagem e upload -->
                        <div class="coluna-imagem">
                            <label for="foto" class="custom-file-upload">SELECIONAR FOTO</label>
                        ...
                        <!-- Coluna dos campos de dados pessoais -->
                    ...
                    <div id="campos-dinamicos" class="especifico" style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                        <!-- Inicialmente ocultos e controlados pela função JavaScript -->
                    </div>
